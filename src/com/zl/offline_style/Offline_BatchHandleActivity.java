...
public class Offline_BatchHandleActivity extends Activity{
	private Offline_BatchDBHelper batchdbhelper;
	private ListView lv;
	...
	private Handler mhandler = new Handler(){
		...
		public void handleMessage(Message msg){
			if(msg.what == 0x01){
				...
				Toast.makeText(Offline_BatchHandleActivity.this, "成功解除锁定！", Toast.LENGTH_SHORT).show();
			}
		}
	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		batchdbhelper = new Offline_BatchDBHelper(this);
	...
	private Runnable showRunnable = new Runnable(){
		...
		public void run() {
			// TODO Auto-generated method stub
				showlist.clear();
				Cursor cur = batchdbhelper.exeSql("select * from batch_list_offline ");
...
private void showRebuildDialog(){
		...
		new AlertDialog.Builder(Offline_BatchHandleActivity.this).setIcon(android.R.drawable.btn_star)  
	    .setTitle("批次表")
	                ...
	                public void onClick(DialogInterface dialog,int which) {
	                	...
	                	if((!batchname.isEmpty())&&(MainActivity.isNumber(batchsum))&&(Integer.parseInt(batchsum)>0)&&(!batchname.equals("EMPTY"))&&(!batchname.equals("NO"))){
	                		...
	                		if(batchdbhelper.updateSum(batchname, batchsum)>0){
	                			new Thread(showRunnable).start();
	                			Toast.makeText(Offline_BatchHandleActivity.this, "更新数据库成功！", Toast.LENGTH_SHORT).show();
	                		}else{
	                			Toast.makeText(Offline_BatchHandleActivity.this, "更新数据库失败！", Toast.LENGTH_SHORT).show();
	                		}
	                	
	                }else{
	                	Toast.makeText(Offline_BatchHandleActivity.this, "输入参数不符合要求，请重新输入！", Toast.LENGTH_SHORT).show();
	                }
	                }
	            })  
...
private void showUnlockDialog(){
    ...
    final EditText edtinput = new EditText(Offline_BatchHandleActivity.this); 
                ...
                String sn = edtinput.getText().toString();
                	...
                	if((!sn.isEmpty())){
                		...
                		if((batchdbhelper.updateFlag(sn,"NO"))>0){
                			...
                			Toast.makeText(Offline_BatchHandleActivity.this, "解除锁定失败！", Toast.LENGTH_SHORT).show();
                		}
