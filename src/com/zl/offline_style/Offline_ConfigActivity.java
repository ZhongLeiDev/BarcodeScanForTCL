...
import com.zl.common_utils.CheckStringTypeUtils;
import com.zl.common_utils.StringTransUtils;

public class Offline_ConfigActivity extends Activity{
	...
	private static final String Properfile = Environment.getExternalStorageDirectory()+ File.separator+"ScanResultData"+File.separator+"Config"+File.separator+"letv_config.dat";
...
//				showmembers.append((String)msg.obj+"\r\n");
				...
				saveConfig(Offline_ConfigActivity.this, Properfile, properties);
				Log.i("CONFIG", "收件人添加成功！");
				Toast.makeText(Offline_ConfigActivity.this, "收件人添加成功！", Toast.LENGTH_SHORT).show();
			}else if(msg.what == 0x02){
				Toast.makeText(Offline_ConfigActivity.this, "收件人地址不合法，请重新输入！", Toast.LENGTH_SHORT).show();
				...
				Toast.makeText(Offline_ConfigActivity.this, "收件人删除成功！", Toast.LENGTH_SHORT).show();
			}else if(msg.what == 0x04){
				Toast.makeText(Offline_ConfigActivity.this, "输入的标号不存在，请重新输入！", Toast.LENGTH_SHORT).show();
			}
		}
	};
	...
	private void updataShowText(){
		...
		for(int i=0;i<memlist.size();i++){
			showmembers.append("【"+i+"】"+memlist.get(i)+"\n");
		}
	}
	...
	private void showClearDialog(){//清空收件人列表提示框
		new AlertDialog.Builder(Offline_ConfigActivity.this).setIcon(android.R.drawable.btn_star)  
