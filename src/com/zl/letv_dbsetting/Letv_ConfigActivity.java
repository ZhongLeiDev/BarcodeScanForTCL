...
public class Letv_ConfigActivity extends Activity{
...
//				showmembers.append((String)msg.obj+"\r\n");
				...
				saveConfig(Letv_ConfigActivity.this, Properfile, properties);
				Log.i("CONFIG", "收件人添加成功！");
				Toast.makeText(Letv_ConfigActivity.this, "收件人添加成功！", Toast.LENGTH_SHORT).show();
			}else if(msg.what == 0x02){
				Toast.makeText(Letv_ConfigActivity.this, "收件人地址不合法，请重新输入！", Toast.LENGTH_SHORT).show();
				...
				Toast.makeText(Letv_ConfigActivity.this, "收件人删除成功！", Toast.LENGTH_SHORT).show();
			}else if(msg.what == 0x04){
				Toast.makeText(Letv_ConfigActivity.this, "输入的标号不存在，请重新输入！", Toast.LENGTH_SHORT).show();
			}
		}
	};
	...
	private void showClearDialog(){//清空收件人列表提示框
		new AlertDialog.Builder(Letv_ConfigActivity.this).setIcon(android.R.drawable.btn_star)  
