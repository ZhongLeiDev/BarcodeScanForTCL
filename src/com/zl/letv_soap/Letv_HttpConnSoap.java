...
public class Letv_HttpConnSoap {
...
//			con.connect();
//			int number = con.getResponseCode();
//			Log.i("HTTP Connect ErrorCode",String.valueOf(number));//查看错误代码
			...
			if (statusCode >= 200 && statusCode < 400) {
			   ...
			   Log.i("ERROR", "错误代码为："+String.valueOf(statusCode)+" ; 错误信息为："+is.toString());
			}*/
